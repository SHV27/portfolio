...
export const URUTHI: Project = {
  ...
  figures: [
    ...
    { value: '52', label: 'unit tests, plus a browser harness covering 28 screens at two widths', derivable: true, receipts: [demo('Every screen is captured at 1440px and 390px with no-console-error and no-horizontal-scroll assertions.')] },
